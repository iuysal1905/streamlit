...
# Read dataset
df_interact = pd.read_excel('ddi_hypo.xlsx')

# Set header title
st.title('Network Graph Visualization of Drug-Drug Interactions')

# Define list of selection options and sort alphabetically
drug_list = ['Lacidipine','Nicorandil','Prazosin','Phentolamine','Tolazoline','Efonidipine','Nitroprusside','Doxazosin','Atenolol','Acebutolol',
'Nadolol','Penbutolol','Pindolol','Bupranolol','Phenoxybenzamine','Nimodipine','Nilvadipine','Lercanidipine','Bepridil','Nitrendipine']
drug_list.sort()
